...
// checkGradeOver70 เป็น Callback Function เพราะเป็นฟังก์ชันที่ส่งไปใช้งานในฟังก์ชัน atLeastFive
2. ใน Exercise นี้ ฟังก์ชันใดเป็น Higher Order Function?
// atLeastFive เป็น Higher Order Function เพราะเป็นฟังก์ชันที่รับฟังก์ชันอื่นมาเป็นพารามิเตอร์
====================================
*/