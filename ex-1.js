...
// addSalary5000 เป็น Callback Function เพราะเป็นฟังก์ชันที่ส่งไปใช้งานในฟังก์ชัน forEach
2. ใน Exercise นี้ ฟังก์ชันใดเป็น Higher Order Function?
// forEach เป็น Higher Order Function เพราะเป็นฟังก์ชันที่รับฟังก์ชันอื่นเป็นพารามิเตอร์
====================================
*/